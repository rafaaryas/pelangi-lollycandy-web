...
<section class="hero hero-like-reference">
    <div class="container hero-grid hero-grid-ref">
        <div class="hero-illustration">
            <img src="{{ asset('https://i.ibb.co.com/ZpyRc5cZ/permen-cyak.png') }}" alt="Lollipop Illustration">
        </div>
        <div class="hero-copy">
            <h1>PELANGI LOLLYCANDY</h1>
            ...
            <div style="display:flex;gap:.7rem;flex-wrap:wrap;margin-top:1rem">
                <a href="{{ route('products.index') }}" class="btn btn-primary btn-outline-white">Lihat Katalog</a>
            </div>
            <div class="stats">
